                    ...
                    <div className="wrapper max-width">
                        ...
                        <div className="sides mt-2">
                            ...
                            <div className="side-c">
                                ...
                                <p>Tutored EdEx coding students for 2 years {/* March 2021 - atm March 2023 */} on the <b>MERN stack + Handlebars + jQuery + MySQL/Sequelize + GraphQL</b>. In addition, MERN Stack is MongoDB/Mongoose, Express, React with Redux, and NodeJS. I am a Senior Tutor who qualified for the entire curriculum because I am MERN certified at UCLA extensions with top marks. Please see 👨🏻‍🏫 <a target="_blank" href="./?page=students"> coding students' reviews</a>.</p>
                                ...
                                */}
                                ...
                                <aside className="badges">
                                    ...
                                    <a className="badge-style-a" target="_blank" href="https://www.youtube.com/user/Siphon880yt/" rel="nofollow">

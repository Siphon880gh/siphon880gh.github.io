                    ...
                    <div className="wrapper max-width">
                        ...
                        <div className="sides mt-2">
                            ...
                            <div className="side-c">
                                ...
                                <p>Full stack developer with 5 years of freelancing <b className='wbr-slash'>Javascript/jQuery/PHP/MySQL</b>. Have worked with startups including Mixotype, and companies like ExRx and People's Care. Known as an innovative problem solver, developer friends go to me when they are stuck or have startup ideas. My strong points are jQuery, PHP, MySQL, React, Express JS, and Node. Please see <a target="_blank" href="./?page=testimonials">testimonials</a>.</p>

                                <p>Tutored students for 2 years on the <b>MERN stack + MySQL/Sequelize + GraphQL</b> (MERN was MongoDB/Mongoose, Express, React, Node JS), currently the highest distinction as a Senior Tutor with edX Coding Bootcamps (Previously Trilogy/2U who purchased edX). I was  MERN certified by UCLA extensions with top marks. My students have given me <a target="_blank" href="./?page=students">excellant student ratings and testimonials</a></p>
